...
public class MySwingFrame extends JFrame {
	...
	private JButton getMyButton() {
		if (this.myButton == null) {
			...
			this.myButton.setText("butt");
			this.myButton.addActionListener(new java.awt.event.ActionListener() {
				@Override
				public void actionPerformed(java.awt.event.ActionEvent e) {
					String msg = e.getActionCommand();
					buttonPressedN++;
					myLabel.setText("butt pressed " + buttonPressedN + " raz");				
			...
			myButton.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyPressed(java.awt.event.KeyEvent e) {
					if (e.getKeyCode() == KeyEvent.VK_ENTER) {
						buttonPressedN++;
						myLabel.setText("butt pressed 2 " + buttonPressedN + " radz");
					}
