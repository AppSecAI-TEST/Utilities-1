 ...
 */
public class MDIStarter extends JFrame implements DockingConstants {
    ...
    private static void runGUI() {
        ...
        MDIStarter flexDockDemo = new MDIStarter();
        flexDockDemo.setSize(800, 600);
        SwingUtility.centerOnScreen(flexDockDemo);
        setCloseOperation(flexDockDemo);
